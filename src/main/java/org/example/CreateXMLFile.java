...
public class CreateXMLFile {
    public static void main(String[] args) {
        try {
            ...
            javax.xml.transform.stream.StreamResult result = new javax.xml.transform.stream.StreamResult(new File("/user/IdeaProjects/JavaLab10/src/main/java/org/example/example.xml"));
